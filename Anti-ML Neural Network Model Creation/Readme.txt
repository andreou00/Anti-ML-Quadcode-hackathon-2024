...
Model Training: We used the generated data to train our Neural Network model. The training and creation of the model were conducted using the script "A_ML_QuadCodehackathon_Neural_Network.ipynb." Our model achieved an impressive accuracy of 97% in detecting money laundering transactions.
